...
public class AppleMobile implements Mobile {
   private String brand;
    ...
    // Constructor for AppleMobile
    public AppleMobile(String brand, String model,int storageCapacityGB, String operatingSystem, double screenSize,int batteryCapacity) {
        this.brand = brand;
        this.model = model;
